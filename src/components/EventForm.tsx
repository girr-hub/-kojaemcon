...
export default function EventForm({ mode, initial }: { mode: Mode; initial?: any }) {
  ...
  const [f, setF] = useState({
    ...
    min_age: (initial as any)?.min_age ?? '',
    max_age: (initial as any)?.max_age ?? '',
    ...
    kakao_chat_url: (initial as any)?.kakao_chat_url ?? '',
  ...
  const submit = async (publish: boolean) => {
    ...
    const payload: any = {
      ...
      min_age: f.min_age ? Number(f.min_age) : null,
      ...
      kakao_chat_url: f.kakao_chat_url,
